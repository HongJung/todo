...
class TodoListsControllerTest < ActionController::TestCase
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post :create, todo_list: { color: @todo_list.color, complete: @todo_list.complete, description: @todo_list.description, due_date: @todo_list.due_date, title: @todo_list.title }
    end
  ...
  test "should update todo_list" do
    patch :update, id: @todo_list, todo_list: { color: @todo_list.color, complete: @todo_list.complete, description: @todo_list.description, due_date: @todo_list.due_date, title: @todo_list.title }
    assert_redirected_to todo_list_path(assigns(:todo_list))
  end
